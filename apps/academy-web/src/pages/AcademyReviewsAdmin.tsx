...
export function AcademyReviewsAdmin() {
  ...
  return <div className="space-y-6">
    ...
    <AdminHelp
      ...
      steps={[
        'Przeczytaj opinię i sprawdź, czy nie zawiera danych osobowych innych osób ani nazw konkurencji.',
        'Kliknij „Opublikuj", żeby pokazać ją na stronie kursu.',
        'Kliknij „Ukryj", jeśli opinia łamie zasady. Kursantka nie dostaje o tym powiadomienia.',
      ]}
    >
      Opinie może wystawić tylko kursantka, która faktycznie ukończyła dany kurs — system sprawdza to sam.
      Żadna nie pojawia się na stronie automatycznie: dopóki nie klikniesz „Opublikuj", widzisz ją tylko Ty.
      <strong> Nie ukrywaj opinii tylko dlatego, że jest krytyczna</strong> — same piątki wyglądają podejrzanie
      i obniżają zaufanie.
    </AdminHelp>
