...
export function AcademyStudio() {
  ...
  const [draft, setDraft] = useState({ title: '', description: '', difficulty: 'BEGINNER', estimatedMinutes: 60, price: 0, thumbnailUrl: '', status: 'DRAFT' });
  ...
  const choose = (course: any) => { setSelectedId(course.id); setDraft({ title: course.title, description: course.description, difficulty: course.difficulty, estimatedMinutes: course.estimatedMinutes, price: Number(course.price || 0), thumbnailUrl: course.thumbnailUrl ?? '', status: course.status }); };
  const newCourse = () => { setSelectedId(null); setDraft({ title: '', description: '', difficulty: 'BEGINNER', estimatedMinutes: 60, price: 0, thumbnailUrl: '', status: 'DRAFT' }); };
