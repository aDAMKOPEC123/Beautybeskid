...
export function LessonQuizPlayer({ quiz, isStandalone: _isStandalone, onPassed }: LessonQuizPlayerProps) {
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <h3 className="text-xl font-bold">
            {result.passed ? 'Gratulacje! Zdales/as!' : 'Niestety, nie udalo sie'}
          </h3>
        ...
        <div className="space-y-4">
          <h4 className="font-semibold">Przeglad odpowiedzi</h4>
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {submitMutation.isPending ? 'Sprawdzanie...' : 'Wyslij odpowiedzi'}
      </button>
    </div>
  );
}
