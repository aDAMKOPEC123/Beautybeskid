...
const DEFAULT_ACHIEVEMENTS = [
  { key: 'FIRST_VISIT', name: 'Pierwsza wizyta', description: 'Witaj w BeskidStudio By Wiktoria Ćwik!', icon: '🌟', pointsBonus: 10, condition: { type: 'VISIT_COUNT', value: 1 }, sortOrder: 1 },
  { key: 'LOYAL_10', name: 'Wierna klientka', description: '10 wizyt w BeskidStudio By Wiktoria Ćwik', icon: '💎', pointsBonus: 20, condition: { type: 'VISIT_COUNT', value: 10 }, sortOrder: 2 },
  { key: 'VIP_50', name: 'VIP', description: '50 wizyt w BeskidStudio By Wiktoria Ćwik', icon: '🏆', pointsBonus: 50, condition: { type: 'VISIT_COUNT', value: 50 }, sortOrder: 3 },
