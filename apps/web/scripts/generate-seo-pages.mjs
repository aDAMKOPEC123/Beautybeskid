...
const corePages = [
  {
    ...
    description: 'Kosmetolog Wiktoria Ćwik koło Limanowej. Konsultacje, laminacja brwi i rzęs, pielęgnacja skóry. Umów wizytę online.',
...
const localPages = [
  ...
  ['podolog-limanowa', 'Podolog Limanowa', 'Pedicure podologiczny, pielęgnacja stóp i konsultacje w okolicach Limanowej.', 'Podolog w BeskidStudio zajmuje się profesjonalną pielęgnacją stóp: pedicure podologicznym, usuwaniem zrogowaceń i odcisków, pielęgnacją problematycznych paznokci oraz konsultacjami stóp. Gabinet mieści się w Mordarce 505, 5 minut od Limanowej. Przed zabiegiem oceniamy stan stóp i dobieramy metodę do konkretnego problemu. Regularna podologia pomaga zapobiegać nawracaniu dolegliwości. Terminy dostępne online.'],
