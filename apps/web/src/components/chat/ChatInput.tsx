    ...
    <div className="flex flex-col gap-2">
      {selectedFile && (
        <div className="flex items-center gap-2 p-2 bg-muted rounded-lg text-sm">
          {previewUrl ? (
            <img src={previewUrl} alt="Podgląd załącznika" className="w-12 h-12 object-cover rounded" loading="lazy" />
          ) : (
      ...
      <div className="flex gap-2 items-end">
        ...
        <label htmlFor="chat-message" className="sr-only">Treść wiadomości</label>
        <textarea
          id="chat-message"
          ref={textareaRef}
          value={content}
