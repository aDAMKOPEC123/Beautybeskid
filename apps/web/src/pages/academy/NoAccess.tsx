...
const BENEFITS = [
  { icon: Video, label: 'Kursy wideo', desc: 'Nagrania i materiały edukacyjne od ekspertów BeskidStudio By Wiktoria Ćwik' },
    ...
    <div className="min-h-screen bg-muted/20 flex items-center justify-center p-4">
      <div className="max-w-lg w-full space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-2xl font-bold font-heading">Akademia BeskidStudio By Wiktoria Ćwik</h1>
            <p className="text-muted-foreground mt-1">
              Ekskluzywna strefa edukacyjna dla klientów BeskidStudio By Wiktoria Ćwik
            </p>
          </div>
        </div>
