  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Kursy, które rozpocząłeś/aś lub ukończyłeś/aś</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 space-y-3">
          ...
          <p className="text-muted-foreground">Nie rozpocząłeś/aś jeszcze żadnego kursu.</p>
          <Link to="/akademia" className="text-sm text-primary hover:underline">
            Przeglądaj katalog
          </Link>
        </div>
      ) : (
