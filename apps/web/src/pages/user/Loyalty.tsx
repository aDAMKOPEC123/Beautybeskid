  ...
  return (
    <div className="space-y-12 animate-enter">
      ...
      <div>
        ...
        <p className="text-sm mb-6" style={{ color: 'rgba(20,40,28,0.5)' }}>
        ...
        {rewardsLoading ? (
          ...
          <div
            ...
            style={{ border: '2px dashed rgba(196,150,90,0.25)', color: 'rgba(20,40,28,0.5)' }}
          >
          ...
          <div className="space-y-3">
            {history?.map((t: any) => {
              const badgeStyle =
                t.type === 'EARN'
                  ...
                  : { background: 'rgba(196,150,90,0.1)', color: '#C4965A' };
            ...
            {history?.length === 0 && (
              <div
                ...
                style={{ background: 'rgba(196,150,90,0.04)', border: '1px solid rgba(196,150,90,0.15)' }}
              >
                <p className="text-sm font-medium" style={{ color: 'rgba(20,40,28,0.5)' }}>
